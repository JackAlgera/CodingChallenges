package com.coding.challenges.codingame.greencircle;
    ...
    while (true) {
      ...
      for (int i = 0; i < cardLocationsCount; i++) {
        ...
        String cardsLocation =
            cardsDetails[0]; // the location of the card list. It can be HAND, DRAW, DISCARD or
        // OPPONENT_CARDS (AUTOMATED and OPPONENT_AUTOMATED will appear in later
        // leagues)
