...
public class Day7 extends Day<Long> {
    ...
    public Long part1(List<String> lines) {
        return lines.stream()
                    .mapToLong(line -> isValid(line, false))
                    .sum();
    }
    ...
    private long evaluate(List<Integer> equation, int i, long target, long current, boolean isPart2) {
        ...
        long concatenate = isPart2 ? evaluate(equation, i + 1, target, Long.parseLong("%d%d".formatted(current, equation.get(i))), isPart2) : 0L;
