package com.coding.challenges.adventofcode.year2020.Day10;
...
public class Day10 extends Day<Long> {
  ...
  public Long part1(List<String> lines) {
    ...
    List<Integer> sortedAdapters =
        lines.stream().mapToInt(Integer::parseInt).sorted().boxed().toList();
  ...
  public Long part2(List<String> lines) {
    List<Integer> adapters =
        new ArrayList<>(
            Stream.concat(Stream.of("0"), lines.stream())
