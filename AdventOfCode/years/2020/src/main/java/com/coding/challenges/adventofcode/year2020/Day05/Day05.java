package com.coding.challenges.adventofcode.year2020.Day05;
...
public class Day05 extends Day<Long> {
  ...
  public Long part1(List<String> lines) {
    return lines.stream().map(this::getSeatId).max(Long::compareTo).get();
  }

  @Override
  public Long part2(List<String> lines) {
    List<Long> ids = lines.stream().map(this::getSeatId).sorted().toList();
