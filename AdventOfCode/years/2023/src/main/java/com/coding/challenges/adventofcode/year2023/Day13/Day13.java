package com.coding.challenges.adventofcode.year2023.Day13;
...
public class Day13 extends Day<Long> {
  ...
  public Long part1(List<String> lines) {
    return parsePatterns(lines).stream().map(this::getPatternNote).mapToLong(Note::val).sum();
  }

  @Override
  public Long part2(List<String> lines) {
    return parsePatterns(lines).stream().mapToLong(this::fixSmudge).sum();
  }
