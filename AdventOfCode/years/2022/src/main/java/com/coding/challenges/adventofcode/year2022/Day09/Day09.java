package com.coding.challenges.adventofcode.year2022.Day09;
...
public class Day09 {
  ...
  private static final String INPUT_NAME = "Year2022/Day9/input.txt";

  public static void main(String[] args) throws IOException {
    Day09 day = new Day09();
    day.part(List.of(new Pair<>(0, 0), new Pair<>(0, 0)), 6494);
    day.part(
        List.of(
            new Pair<>(0, 0),
            new Pair<>(0, 0),
  ...
  private void part(List<Pair<Integer>> joints, int expectedValue) throws IOException {
    ...
    while (br.ready()) {
      ...
      while (steps > 0) {
        ...
        //                System.out.println("Pos head: " + head.getFirst() + " " + head.getSecond()
        // + ", pos tail: " + tail.getFirst() + " " + tail.getSecond());
        steps--;
      }
    }
